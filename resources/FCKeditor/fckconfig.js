...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/cream/' ;
...
FCKConfig.ToolbarSets["Default"] = [
 ['Preview','-','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
 ['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','OrderedList','UnorderedList','-','Outdent','Indent','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor'],
 ['FontName','FontSize','Link','Unlink','Image','Table','Rule','SpecialChar','UniversalKey', 'Smiley']
] ;
...
FCKConfig.LinkBrowserWindowWidth	= 320 ;	// 70%
...
FCKConfig.ImageBrowserWindowWidth  = 320 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 240 ;	// 70% ;
...
FCKConfig.FlashBrowserWindowWidth  = 320 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = 240 ;	//70% ;
