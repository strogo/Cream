...
public class ShedVelocityTool
{
    static Log log = LogFactory.getLog( ShedVelocityTool.class );
     ...
     */
    public ShedVelocityTool( Context c )
    {
        context = c;
    }
    ...
    public String evaluate( String s )
    {
        if ( s != null )
        {
            ...
            try
            {
                Velocity.evaluate( context, stringWriter, "ShedVelocityTool.evaluate", s );
                stringWriter.close();
