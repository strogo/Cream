    ...
    implements org.apache.turbine.om.Retrievable
{
    ...
    public void setOnlineSubsId(int v) throws TorqueException
    {
            ...
            setModified(true);
                  ...
                  // update associated OnlineSubscriptionIp
        if (collOnlineSubscriptionIps != null)
        {
            for (int i = 0; i < collOnlineSubscriptionIps.size(); i++)
            {
                ((OnlineSubscriptionIp) collOnlineSubscriptionIps.get(i))
                    .setOnlineSubsId(v);
            }
        }
                                }
    ...
    public void setSorderKey(ObjectKey key) throws TorqueException
    {
          ...
          /**
     * Collection to store aggregation of collOnlineSubscriptionIps
     */
    protected List collOnlineSubscriptionIps;

    /**
     * Temporary storage of collOnlineSubscriptionIps to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initOnlineSubscriptionIps()
    {
        if (collOnlineSubscriptionIps == null)
        {
            collOnlineSubscriptionIps = new ArrayList();
        }
    }

    /**
     * Method called to associate a OnlineSubscriptionIp object to this object
     * through the OnlineSubscriptionIp foreign key attribute
     *
     * @param l OnlineSubscriptionIp
     * @throws TorqueException
     */
    public void addOnlineSubscriptionIp(OnlineSubscriptionIp l) throws TorqueException
    {
        getOnlineSubscriptionIps().add(l);
        l.setOnlineSubscription((OnlineSubscription) this);
    }

    /**
     * The criteria used to select the current contents of collOnlineSubscriptionIps
     */
    private Criteria lastOnlineSubscriptionIpsCriteria = null;
      
    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getOnlineSubscriptionIps(new Criteria())
     *
     * @throws TorqueException
     */
    public List getOnlineSubscriptionIps() throws TorqueException
    {
              if (collOnlineSubscriptionIps == null)
        {
            collOnlineSubscriptionIps = getOnlineSubscriptionIps(new Criteria(10));
        }
        return collOnlineSubscriptionIps;
          }

    /**
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this OnlineSubscription has previously
     * been saved, it will retrieve related OnlineSubscriptionIps from storage.
     * If this OnlineSubscription is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getOnlineSubscriptionIps(Criteria criteria) throws TorqueException
    {
              if (collOnlineSubscriptionIps == null)
        {
            if (isNew())
            ...
            {
                        criteria.add(OnlineSubscriptionIpPeer.ONLINE_SUBS_ID, getOnlineSubsId() );
                        collOnlineSubscriptionIps = OnlineSubscriptionIpPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                // one, just return the collection.
                            criteria.add(OnlineSubscriptionIpPeer.ONLINE_SUBS_ID, getOnlineSubsId());
                            if (!lastOnlineSubscriptionIpsCriteria.equals(criteria))
                {
                    collOnlineSubscriptionIps = OnlineSubscriptionIpPeer.doSelect(criteria);
                }
            }
        }
        lastOnlineSubscriptionIpsCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getOnlineSubscriptionIps(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getOnlineSubscriptionIps(Connection con) throws TorqueException
    {
              if (collOnlineSubscriptionIps == null)
        {
            collOnlineSubscriptionIps = getOnlineSubscriptionIps(new Criteria(10), con);
        }
        return collOnlineSubscriptionIps;
          }
     ...
     * that is taken as input
     */
    public List getOnlineSubscriptionIps(Criteria criteria, Connection con)
            throws TorqueException
    {
              if (collOnlineSubscriptionIps == null)
        {
            ...
            {
                         criteria.add(OnlineSubscriptionIpPeer.ONLINE_SUBS_ID, getOnlineSubsId());
                         collOnlineSubscriptionIps = OnlineSubscriptionIpPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this OnlineSubscription is new, it will return
     * an empty collection; or if this OnlineSubscription has previously
     * been saved, it will retrieve related OnlineSubscriptionIps from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OnlineSubscription.
     */
    protected List getOnlineSubscriptionIpsJoinOnlineSubscription(Criteria criteria)
        throws TorqueException
    {
                    if (collOnlineSubscriptionIps == null)
        {
            ...
            {
                              criteria.add(OnlineSubscriptionIpPeer.ONLINE_SUBS_ID, getOnlineSubsId());
                              collOnlineSubscriptionIps = OnlineSubscriptionIpPeer.doSelectJoinOnlineSubscription(criteria);
            }
        }
        else
        {
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
                    ...
                    if (collOnlineSubscriptionIps != null)
            {
                for (int i = 0; i < collOnlineSubscriptionIps.size(); i++)
                {
                    ((OnlineSubscriptionIp) collOnlineSubscriptionIps.get(i)).save(con);
                }
            }
                                  alreadyInSave = false;
        }
    ...
    protected OnlineSubscription copyInto(OnlineSubscription copyObj) throws TorqueException
    {
        ...
        List v = getOnlineSubscriptionIps();
        for (int i = 0; i < v.size(); i++)
        {
            OnlineSubscriptionIp obj = (OnlineSubscriptionIp) v.get(i);
            copyObj.addOnlineSubscriptionIp(obj.copy());
        }
                            return copyObj;
    }
