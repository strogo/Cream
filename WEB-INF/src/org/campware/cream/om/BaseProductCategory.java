    ...
    implements org.apache.turbine.om.Retrievable
{
    ...
    /** The value for the productCatName field */
    ...
    public void setProductCatName(String v) 
    {
                  ...
                  if (!ObjectUtils.equals(this.productCatName, v))
              {
            this.productCatName = v;
            setModified(true);
        }
    ...
    public Object getByName(String name)
    {
          if (name.equals("ProductCatId"))
        {
          ...
          if (name.equals("ProductCatName"))
        {
                return getProductCatName();
            }
          return null;
    }
    ...
    {
          if (name.equals(ProductCategoryPeer.PRODUCT_CAT_ID))
        {
                return new Integer(getProductCatId());
            }
          if (name.equals(ProductCategoryPeer.PRODUCT_CAT_NAME))
        {
                return getProductCatName();
            }
          return null;
     ...
     *
     * @param key productCatId ObjectKey
     */
    ...
    protected ProductCategory copyInto(ProductCategory copyObj) throws TorqueException
    {
          ...
          copyObj.setProductCatName(productCatName);
    ...
    public String toString()
    {
        ...
        str.append("ProductCatId = ")
             ...
             .append("\n");
        str.append("ProductCatName = ")
               .append(getProductCatName())
             .append("\n");
        return(str.toString());
    }
}
