    ...
    extends BasePeer
{
    ...
    public static final String TASK_ID;
      /** the column name for the TASK_CODE field */
    public static final String TASK_CODE;
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(TASK_CODE);
          ...
          criteria.addSelectColumn(PROGRESS);
          ...
          criteria.addSelectColumn(ACCESS);
          criteria.addSelectColumn(ASSIGNED_TO);
        ...
        throws TorqueException
    {
        try
        {
                obj.setTaskId(row.getValue(offset + 0).asInt());
                  obj.setTaskCode(row.getValue(offset + 1).asString());
                  ...
                  obj.setDueDate(row.getValue(offset + 5).asUtilDate());
                  obj.setProgress(row.getValue(offset + 6).asInt());
                  obj.setCustomerId(row.getValue(offset + 7).asInt());
                  obj.setContactId(row.getValue(offset + 8).asInt());
                  obj.setProductId(row.getValue(offset + 9).asInt());
                  obj.setProjectId(row.getValue(offset + 10).asInt());
                  obj.setAccess(row.getValue(offset + 11).asInt());
                  obj.setAssignedTo(row.getValue(offset + 12).asString());
                  obj.setSubject(row.getValue(offset + 13).asString());
                  obj.setDescription(row.getValue(offset + 14).asString());
                  obj.setCreated(row.getValue(offset + 15).asUtilDate());
                  obj.setModified(row.getValue(offset + 16).asUtilDate());
                  obj.setCreatedBy(row.getValue(offset + 17).asString());
                  obj.setModifiedBy(row.getValue(offset + 18).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
    ...
    public static Criteria buildCriteria( Task obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(TASK_ID, obj.getTaskId());
              criteria.add(TASK_CODE, obj.getTaskCode());
              ...
              criteria.add(PROGRESS, obj.getProgress());
              ...
              criteria.add(ACCESS, obj.getAccess());
              criteria.add(ASSIGNED_TO, obj.getAssignedTo());
        ...
        throws TorqueException
    {
        ...
        CustomerPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(TaskPeer.CUSTOMER_ID,
        ...
        throws TorqueException
    {
        ...
        ProjectPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(TaskPeer.PROJECT_ID,
        ...
        throws TorqueException
    {
        ...
        ProductPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(TaskPeer.PRODUCT_ID,
        ...
        throws TorqueException
    {
        ...
        int offset4 = offset3 + ProjectPeer.numColumns;
                    ...
                    ContactPeer.addSelectColumns(criteria);
        int offset5 = offset4 + ContactPeer.numColumns;
        ...
        for (int i = 0; i < rows.size(); i++)
        {
                            ...
                            if (newObject)
            {
                ...
                obj3.addTask(obj1);
                           ...
                           omClass = ContactPeer.getOMClass();
                          Contact obj4 = (Contact)ContactPeer
                .row2Object( row, offset4, omClass);
            ...
            {
                Task temp_obj1 = (Task)results.get(j);
                Contact temp_obj4 = (Contact)temp_obj1.getContact();
                if (temp_obj4.getPrimaryKey().equals(obj4.getPrimaryKey()))
                {
                    newObject = false;
                                    temp_obj4.addTask(obj1);
