    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        try
        {
                obj.setSorderId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setCurrencyAmount(row.getValue(offset + 13).asBigDecimal());
        ...
        throws TorqueException
    {
        ...
        int offset3 = offset2 + ProjectPeer.numColumns;
                    ...
                    CarrierPeer.addSelectColumns(criteria);
        int offset4 = offset3 + CarrierPeer.numColumns;
        ...
        for (int i = 0; i < rows.size(); i++)
        {
                            ...
                            if (newObject)
            {
                ...
                obj2.addSorder(obj1);
                           ...
                           omClass = CarrierPeer.getOMClass();
                          Carrier obj3 = (Carrier)CarrierPeer
            ...
            {
                Sorder temp_obj1 = (Sorder)results.get(j);
                Carrier temp_obj3 = (Carrier)temp_obj1.getCarrier();
