 ...
 *
 */
public abstract class BaseSorderPeer
    extends BasePeer
{
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Sorder row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(SorderPeer.row2Object(row, 1,
                SorderPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Sorder obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Sorder obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Sorder obj, Connection con)
        throws TorqueException
    {
     ...
     */
    public static Sorder retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Sorder retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Sorder retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Sorder retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Sorder retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        throws TorqueException
    {
        ...
        CustomerPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.CUSTOMER_ID,
        ...
        throws TorqueException
    {
        ...
        CustomerPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.RECIPIENT_ID,
            CustomerPeer.CUSTOMER_ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinOpportunity(Criteria criteria)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        OpportunityPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.OPPORTUNITY_ID,
            OpportunityPeer.OPPORTUNITY_ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                ...
                .row2Object(row, 1, omClass);
                    ...
                    Opportunity obj2 = (Opportunity)OpportunityPeer
                .row2Object(row, offset, omClass);
        ...
        throws TorqueException
    {
        ...
        ProjectPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.PROJECT_ID,
        ...
        throws TorqueException
    {
        ...
        CarrierPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.CARRIER_ID,
        ...
        throws TorqueException
    {
        ...
        CurrencyPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(SorderPeer.CURRENCY_ID,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptOpportunity(Criteria criteria)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
                            ...
                            if (newObject)
            {
                ...
                obj3.addSorderRelatedByRecipientId(obj1);
                           ...
                           omClass = OpportunityPeer.getOMClass();
                          Opportunity obj4 = (Opportunity)OpportunityPeer
                .row2Object( row, offset4, omClass);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
                            ...
                            if (newObject)
            {
                ...
                obj5.addSorder(obj1);
                           ...
                           omClass = CarrierPeer.getOMClass();
                          Carrier obj6 = (Carrier)CarrierPeer
                .row2Object( row, offset6, omClass);
