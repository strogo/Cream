 ...
 * extended all references should be to ProjectDoc
 */
public abstract class BaseProjectDoc extends BaseObject
    implements org.apache.turbine.om.Retrievable
{
    /** The Peer class */
    private static final ProjectDocPeer peer =
        new ProjectDocPeer();
    ...
    {
          if (name.equals(ProjectDocPeer.DOC_ID))
        {
                return new Integer(getDocId());
            }
          if (name.equals(ProjectDocPeer.DOC_TYPE))
        {
                return new Integer(getDocType());
            }
          if (name.equals(ProjectDocPeer.DOC_CODE))
        {
                return new Integer(getDocCode());
            }
          if (name.equals(ProjectDocPeer.STATUS))
        {
                return new Integer(getStatus());
            }
          if (name.equals(ProjectDocPeer.SUBJECT))
        {
                return getSubject();
            }
          if (name.equals(ProjectDocPeer.ISSUED_DATE))
        {
                return getIssuedDate();
            }
          if (name.equals(ProjectDocPeer.PROJECT_ID))
        {
                return new Integer(getProjectId());
            }
          if (name.equals(ProjectDocPeer.CREATED))
        {
                return getCreated();
            }
          return null;
    ...
    {
          save(ProjectDocPeer.getMapBuilder()
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    ProjectDocPeer.doInsert((ProjectDoc) this, con);
                    setNew(false);
                }
                else
                {
                    ProjectDocPeer.doUpdate((ProjectDoc) this, con);
                }
            }
     ...
     * related objects to isNew=true.
       */
      public ProjectDoc copy() throws TorqueException
    {
        return copyInto(new ProjectDoc());
    }
  
    protected ProjectDoc copyInto(ProjectDoc copyObj) throws TorqueException
    {
