    ...
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.campware.cream.om.TurbineScheduledJob";
    ...
    public static Criteria buildSelectCriteria( TurbineScheduledJob obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                    criteria.add(JOB_ID, obj.getJobId());
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TurbineScheduledJob retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
