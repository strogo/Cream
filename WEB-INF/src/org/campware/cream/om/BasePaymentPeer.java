 ...
 *
 */
public abstract class BasePaymentPeer
    extends BasePeer
{
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Payment row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(PaymentPeer.row2Object(row, 1,
                PaymentPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Payment obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Payment obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Payment obj, Connection con)
        throws TorqueException
    {
     ...
     */
    public static Payment retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Payment retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Payment retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Payment retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Payment retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        throws TorqueException
    {
        ...
        CustomerPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PaymentPeer.CUSTOMER_ID,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                    ...
                    Payment obj1 = (Payment) PaymentPeer
        ...
        throws TorqueException
    {
        ...
        ProjectPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PaymentPeer.PROJECT_ID,
        ...
        throws TorqueException
    {
        ...
        SorderPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PaymentPeer.SORDER_ID,
        ...
        throws TorqueException
    {
        ...
        CurrencyPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(PaymentPeer.CURRENCY_ID,
